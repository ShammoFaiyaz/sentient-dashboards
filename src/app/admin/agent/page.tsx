...
export default function AdminAgentActive() {
  ...
  return (
    <div className="mx-auto max-w-7xl px-1.5 py-4">
      ...
      <p className="mt-1 text-xs text-muted">Admin-specific agents</p> */}
      <div className="mt-2 flex items-center justify-start">
        <label className="text-sm" htmlFor="admin-agent-filter">
      ...
      <div className="mt-4 grid gap-4 md:grid-cols-2 lg:grid-cols-3">
        ...
        {list.length === 0 && (
          <div className="text-sm text-muted">No agents available.</div>
        )}
      </div>
    </div>
  );
