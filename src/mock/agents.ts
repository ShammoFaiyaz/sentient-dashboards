...
export const agents: Agent[] = [
  ...
  { id: "personalized-course-design", name: "Personalized Course Designer", description: "Builds adaptive curriculum pathways based on goals and prior learning.", bullets: ["Aligns to degree plan", "Adapts pacing"], color: "primary", icon: "book", role: "teacher", url: "https://www.bldr.bot/en/bot/curriculumarchitect", category: "Curriculum & Teaching" },
  { id: "digital-fluency-ethics", name: "AI Literacy & Ethics Mentor", description: "Interactive modules to learn AI literacy and responsible use.", bullets: ["Short micro-lessons", "Scenario practice"], color: "accent", icon: "brain", role: "student", url: "https://www.bldr.bot/en/bot/axiom-the-ethical-ai-compass", category: "Curriculum & Teaching" },
  { id: "ai-tutor-writer", name: "AI Tutor & Writing Assistant", description: "On-demand explanations, outlines, and draft feedback with citations.", bullets: ["Explain simply", "Draft with sources"], color: "primary", icon: "bot", role: "student", url: "https://www.bldr.bot/en/bot/inova-english-unit-1", category: "Curriculum & Teaching" },
  ...
  { id: "career-coach", name: "Virtual Career Coach", description: "Resume review, interview prep, and matching to roles.", bullets: ["ATS resume tips", "Mock interviews"], color: "primary", icon: "briefcase", role: "student", url: "https://www.bldr.bot/en/bot/careercompass", category: "Student Support" },
  ...
  { id: "job-matching", name: "AI Job Matching", description: "Recommends internships and roles based on skills and interests.", bullets: ["Skill matching", "Live postings"], color: "primary", icon: "briefcase", role: "student", url: "https://www.bldr.bot/en/bot/careercompass", category: "Careers" },
  { id: "skill-gap", name: "Skill-Gap Analyzer", description: "Finds gaps vs. target roles and suggests learning modules.", bullets: ["Gap radar", "Next steps"], color: "accent", icon: "brain", role: "student", url: "https://www.bldr.bot/en/bot/careercompass", category: "Careers" },
  { id: "personalized-learning-paths", name: "Personalized Learning Pathways", description: "Adaptive nudging and pacing for each student.", bullets: ["Learning nudges", "Path adjustments"], color: "violet", icon: "sparkles", role: "student", url: "https://www.bldr.bot/en/bot/campusally", category: "Student Support" },
  ...
  { id: "faculty-copilot", name: "Faculty Co‑Pilot", description: "Assists with course design, announcements, and class facilitation.", bullets: ["Drafts content", "Live session helpers"], color: "primary", icon: "sparkles", role: "teacher", url: "https://www.bldr.bot/en/bot/curriculumarchitect", category: "Teaching Support" },
  { id: "genai-assistant", name: "Generative Teaching Assistant", description: "Drafts lesson content, examples, and assessment items.", bullets: ["Examples on demand", "Item bank seeds"], color: "accent", icon: "bot", role: "teacher", url: "https://www.bldr.bot/en/bot/the-prompting-academy-tutor", category: "Teaching Support" },
  ...
  { id: "ai-literacy-training", name: "AI Literacy & Prompt Training", description: "Guided prompt libraries and micro‑courses for faculty.", bullets: ["Prompt patterns", "Micro‑courses"], color: "primary", icon: "book", role: "teacher", url: "https://www.bldr.bot/en/bot/the-prompting-academy-tutor", category: "Staff Development" },
  ...
  { id: "integrated-course-design", name: "AI‑Integrated Course Design", description: "Plan outcome‑aligned modules and personalized pathways.", bullets: ["Outcome mapping", "Pacing plans"], color: "primary", icon: "book", role: "teacher", url: "https://www.bldr.bot/en/bot/curriculumarchitect", category: "Curriculum & Teaching" },
  ...
  { id: "nlp-doc-automation", name: "NLP Documentation Automation", description: "Automate report writing with templates and data.", bullets: ["Template fills", "Data merge"], color: "primary", icon: "book", role: "admin", url: "https://www.bldr.bot/en/bot/ai-audit-iso-9001", category: "University Administration" },
  { id: "policy-drafter", name: "LLM Policy Drafter", description: "Summarization and policy support for committees.", bullets: ["Summaries", "Draft proposals"], color: "violet", icon: "shield", role: "admin", url: "https://www.bldr.bot/en/bot/ai-audit-iso-9001", category: "University Administration" },
